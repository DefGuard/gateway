...
<div class="tab-content content-box">
   <div id="general" class="tab-pane fade in active">
      <?= $this->partial('layout_partials/base_form', ['fields' => $formGeneralSettings, 'id' => 'frm_GeneralSettings']) ?>
...
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditAlert, 'id' => 'DialogEditAlert', 'label' => 'Edit Alert&nbsp;&nbsp;<small>NOTE: For a detailed description see monit(1) section "ALERT MESSAGES".</small>']) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditService, 'id' => 'DialogEditService', 'label' => 'Edit Service']) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditTest, 'id' => 'DialogEditTest', 'label' => 'Edit Test&nbsp;&nbsp;<small>NOTE: For a detailed description see monit(1) section "SERVICE TESTS".</small>']) ?>
