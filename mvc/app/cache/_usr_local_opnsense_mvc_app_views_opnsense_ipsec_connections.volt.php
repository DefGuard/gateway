...
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogConnection, 'id' => 'DialogConnection', 'label' => $lang->_('Edit Connection')]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogLocal, 'id' => 'DialogLocal', 'label' => $lang->_('Edit Local')]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogRemote, 'id' => 'DialogRemote', 'label' => $lang->_('Edit Remote')]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogChild, 'id' => 'DialogChild', 'label' => $lang->_('Edit Child')]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogPool, 'id' => 'DialogPool', 'label' => $lang->_('Edit Pool')]) ?>
